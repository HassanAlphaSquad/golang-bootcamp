...
module github.com/HassanAlphaSquad/golang-bootcamp/tree/main/hellogo

go 1.23.6

replace github.com/HassanAlphaSquad/golang-bootcamp/tree/main/mystrings v0.0.0 => ../mystrings

require github.com/HassanAlphaSquad/golang-bootcamp/tree/main/mystrings v0.0.0
